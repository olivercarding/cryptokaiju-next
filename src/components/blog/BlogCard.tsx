...
export default function BlogCard({ post, index }: BlogCardProps) {
  ...
  return (
    ...
    >
      <Link
        href={`/blog/${slugStr}`}
        className="group bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-kaiju-pink/30 h-full flex flex-col block"
      >
        {/* Featured Image */}
        ...
        <div className="p-6 flex-1 flex flex-col">
          ...
          {/* Read More Indicator */}
          <div className="inline-flex items-center gap-2 text-kaiju-pink group-hover:text-kaiju-red font-bold group-hover:gap-3 transition-all duration-300 mt-auto">
            Read Full Article
