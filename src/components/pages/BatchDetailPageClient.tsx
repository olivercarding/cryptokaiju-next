...
const richTextOptions: any = {
  ...
  renderNode: {
    ...
    [BLOCKS.UL_LIST]: (_n: any, c: ReactNode) => <ul className="list-disc list-inside mb-4 space-y-2 text-kaiju-navy/80">{c}</ul>,
    [BLOCKS.OL_LIST]: (_n: any, c: ReactNode) => <ol className="list-decimal list-inside mb-4 space-y-2 text-kaiju-navy/80">{c}</ol>,
    [BLOCKS.LIST_ITEM]: (_n: any, c: ReactNode) => <li className="ml-4">{c}</li>,
